const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./4dpK5yxW.js","./D4lRaw02.js","./uYr82bVc.js"])))=>i.map(i=>d[i]);
import{p as Z,O as ve,l as f,m as B,x as xe,e as me,g as Se,o as r,c as l,b as h,T as he,w as ge,j as i,a as e,d as T,t as d,F as I,r as F,Z as we,n as b,k,s as z,N as ye,B as ne,P as ke,Q as Ce,H as Ae,G as Te,R as K,_ as fe,h as Ie,U as De,V as Pe,C as te}from"./DThYVGiQ.js";import{r as Re}from"./DI3ESgBs.js";import{B as Y}from"./DlW-5Lyw.js";import{S as Ee}from"./BNL2c--L.js";import{R as Me}from"./BqZhjBv3.js";import{L as oe}from"./DmVw3hH4.js";import{C as ae}from"./fRVsUKuI.js";import{S as Le}from"./BtDjEasB.js";import{G as ie}from"./CZM96mcE.js";import{B as _e}from"./qoqWDxai.js";import{R as re}from"./DGJEr0F0.js";import{C as He}from"./DIO2Q41o.js";import{C as le}from"./AHtxuIvv.js";import"./H0Xt2gCH.js";import"./uYr82bVc.js";const Oe=Z("award",[["path",{d:"m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526",key:"1yiouv"}],["circle",{cx:"12",cy:"8",r:"6",key:"1vp47v"}]]);const se=Z("chevron-left",[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]]);const Fe=Z("target",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["circle",{cx:"12",cy:"12",r:"6",key:"1vlfrh"}],["circle",{cx:"12",cy:"12",r:"2",key:"1c9p78"}]]);const je=Z("user",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]),qe="vindicta-academy.bin",ce="academy-state";async function de(){const{Store:w}=await xe(async()=>{const{Store:c}=await import("./4dpK5yxW.js");return{Store:c}},__vite__mapDeps([0,1,2]),import.meta.url);return w.load(qe)}const ue=30,be=ve("academy",()=>{const w=f(null),c=f(null),p=f({}),m=f(null),v=f(null),_=f(null),R=f(!1),E=f(!1),W=B(()=>Object.values(p.value).filter(o=>o.completedAt!==null).length),C=B(()=>W.value>=ue),D=B(()=>Math.round(W.value/ue*100));function M(o){return!!p.value[o]?.completedAt}function A(o){return!!p.value[o]?.startedAt}async function x(){try{const o=await de();await o.set(ce,{mode:w.value,aiModel:c.value,completedLessons:p.value,certificateIssuedAt:m.value,lastVisitedModuleId:v.value,lastVisitedLessonId:_.value,setupComplete:R.value}),await o.save()}catch(o){console.warn("[Academy] Save failed:",o)}}async function L(){if(!E.value)try{const t=await(await de()).get(ce);t&&(w.value=t.mode??null,c.value=t.aiModel??null,p.value=t.completedLessons??{},m.value=t.certificateIssuedAt??null,v.value=t.lastVisitedModuleId??null,_.value=t.lastVisitedLessonId??null,R.value=t.setupComplete??!1)}catch(o){console.warn("[Academy] Load failed:",o)}finally{E.value=!0}}async function $(o,t){w.value=o,c.value=t,R.value=!0,await x()}async function j(){w.value=null,c.value=null,R.value=!1,await x()}async function G(o){p.value[o]||(p.value[o]={completedAt:null,startedAt:new Date().toISOString()},await x())}async function O(o){const t=p.value[o];p.value[o]={startedAt:t?.startedAt??new Date().toISOString(),completedAt:new Date().toISOString()},C.value&&!m.value&&(m.value=new Date().toISOString()),await x()}async function V(o,t){v.value=o,_.value=t,await x()}return{mode:w,aiModel:c,completedLessons:p,certificateIssuedAt:m,lastVisitedModuleId:v,lastVisitedLessonId:_,setupComplete:R,completedCount:W,allCompleted:C,progressPercent:D,isCompleted:M,isStarted:A,loadFromDisk:L,setSetup:$,resetSetup:j,startLesson:G,completeLesson:O,setLastVisited:V}}),X=[{number:1,title:"Week 1",theme:"Security Foundations",color:"text-indigo-300",bg:"bg-indigo-500/10",border:"border-indigo-500/20"},{number:2,title:"Week 2",theme:"Web App Security",color:"text-violet-300",bg:"bg-violet-500/10",border:"border-violet-500/20"},{number:3,title:"Week 3",theme:"Penetration Testing",color:"text-rose-300",bg:"bg-rose-500/10",border:"border-rose-500/20"},{number:4,title:"Week 4",theme:"Defensive Security",color:"text-emerald-300",bg:"bg-emerald-500/10",border:"border-emerald-500/20"},{number:5,title:"Capstone",theme:"Assessment",color:"text-amber-300",bg:"bg-amber-500/10",border:"border-amber-500/20"}],pe=30,U=[{id:"day-1",day:1,week:1,title:"The Security Mindset",duration:"45 min",objectives:["Understand the CIA Triad: Confidentiality, Integrity, Availability","Think like an attacker to build better defenses","Recognize the difference between security and compliance"],content:`# Day 1 — The Security Mindset
...
Continue your journey: pursue OSCP, CEH, or eJPT certifications. Practice on HackTheBox and TryHackMe. Build security tooling. Stay curious.`,labHint:"Write a complete professional report for the red team exercise you conducted on Day 29. Include all sections. Share it with a colleague for feedback on clarity."}];function We(w){return U.find(c=>c.id===w)}const Ne={class:"flex h-full flex-col overflow-hidden rounded-xl border border-indigo-500/20 bg-black/20"},Ue={key:0,class:"flex h-full flex-col items-center justify-center gap-5 p-5"},ze={class:"text-center space-y-1"},$e={class:"mx-auto grid size-12 place-items-center rounded-2xl border border-indigo-500/20 bg-indigo-500/10"},Ve={class:"text-[11px] text-[var(--text-muted)]"},Be={class:"text-[var(--text)]"},Ge={class:"w-full space-y-2"},Qe={class:"space-y-2"},Xe=["onClick"],Ke={class:"flex-1 min-w-0"},Ye={class:"flex items-center gap-1.5"},Ze={class:"text-xs font-semibold text-[var(--text)]"},Je={key:0,class:"rounded-full border border-violet-500/25 bg-violet-500/10 px-1.5 py-0.5 text-[9px] font-semibold text-violet-300"},et={class:"mt-0.5 text-[11px] text-[var(--text-faint)]"},tt={key:0,class:"mt-0.5 text-[10px] text-amber-400/70 italic"},it={key:1,class:"flex h-full flex-col overflow-hidden"},st={class:"flex shrink-0 items-center gap-2.5 border-b border-indigo-500/15 px-4 py-2.5"},at={class:"grid size-7 shrink-0 place-items-center rounded-lg border border-indigo-500/20 bg-indigo-500/10"},nt={class:"flex-1 min-w-0"},ot={class:"text-[10px] text-[var(--text-faint)]"},rt={key:0,class:"flex h-full items-center justify-center"},lt={key:0,class:"flex items-start gap-2"},ct={class:"mt-0.5 grid size-6 shrink-0 place-items-center rounded-full border border-indigo-500/20 bg-indigo-500/10"},dt={class:"flex-1 min-w-0 space-y-2"},ut=["innerHTML"],pt={key:1,class:"flex items-center gap-1.5 px-1"},mt={key:2,class:"rounded-xl border border-indigo-500/20 bg-black/20 p-3 space-y-2"},ht={class:"text-[11px] font-semibold text-[var(--text)]"},gt={class:"space-y-1.5"},yt=["disabled","onClick"],ft={class:"grid size-5 shrink-0 place-items-center rounded border border-current text-[10px] font-bold"},bt={key:3,class:"rounded-xl border border-indigo-500/20 bg-black/20 p-3 space-y-2"},vt={class:"text-[11px] font-semibold text-[var(--text)]"},xt={class:"flex items-center gap-2"},St=["onUpdate:modelValue","type","onKeydown"],wt=["onClick"],kt={key:1,class:"flex items-start gap-2 flex-row-reverse"},Ct={class:"mt-0.5 grid size-6 shrink-0 place-items-center rounded-full border border-[var(--border)] bg-white/[0.04]"},At={class:"max-w-[85%] rounded-xl rounded-tr-none border border-[var(--border)] bg-white/[0.04] px-3 py-2 text-xs text-[var(--text-muted)]"},Tt={key:1,class:"flex justify-center pt-1"},It={class:"shrink-0 border-t border-indigo-500/15 p-3"},Dt={class:"flex items-end gap-2 rounded-xl border border-indigo-500/20 bg-black/20 px-3 py-2 focus-within:border-indigo-500/40"},Pt=["disabled"],Rt=["disabled"],Et=me({__name:"AIProfessorChat",props:{lesson:{},lessonCompleted:{type:Boolean}},emits:["markComplete"],setup(w,{emit:c}){const p=w,m=c,v=be(),_=Se(),R=f(!1),E=f(v.aiModel??"claude"),W=[{id:"claude",label:"Claude",sublabel:"Anthropic Claude Code",color:"text-violet-300",bg:"bg-violet-500/10",border:"border-violet-500/25",icon:Ee},{id:"codex",label:"Codex",sublabel:"OpenAI Codex CLI",note:"Code analysis mode — professor uses Claude",color:"text-emerald-300",bg:"bg-emerald-500/10",border:"border-emerald-500/25",icon:we}];async function C(){await v.setSetup(v.mode??"ai-assisted",E.value),R.value=!0,await K(),await V()}const D=f([]),M=f(""),A=f(!1),x=f(null);let L=1;function $(u){const n=u.match(/QUIZ:MC\n(.*)\n((?:[A-D]\).*\n?)+)ANSWER:([A-D])/m);if(n){const S=(n[1]??"").trim(),Q=(n[2]??"").trim().split(`
`).map(N=>{const ee=N.match(/^([A-D])\)\s*(.+)/);return ee?{letter:ee[1]??"",text:(ee[2]??"").trim()}:null}).filter(N=>N!==null);return{cleanText:u.replace(/QUIZ:MC[\s\S]*?ANSWER:[A-D]/m,"").trim(),quiz:{type:"mc",question:S,options:Q,answered:!1}}}const s=u.match(/QUIZ:TEXT\n([\s\S]+?)\/QUIZ/);if(s){const S=(s[1]??"").trim();return{cleanText:u.replace(/QUIZ:TEXT\n[\s\S]+?\/QUIZ/,"").trim(),quiz:{type:"text",question:S,answered:!1,studentInput:""}}}const y=u.match(/QUIZ:NUMBER\n([\s\S]+?)\/QUIZ/);if(y){const S=(y[1]??"").trim();return{cleanText:u.replace(/QUIZ:NUMBER\n[\s\S]+?\/QUIZ/,"").trim(),quiz:{type:"number",question:S,answered:!1,studentInput:""}}}return{cleanText:u,quiz:null}}function j(){const u=p.lesson.objectives.map(s=>`- ${s}`).join(`
`),n=p.lesson.content.slice(0,800)+(p.lesson.content.length>800?"...":"");return`You are Professor Vindicta, an expert cybersecurity instructor running a 30-day security bootcamp.
The student is currently on Day ${p.lesson.day}: "${p.lesson.title}".
...
Be conversational and specific to today's lesson.`}function G(u){const n=D.value.slice(-6).map(s=>`${s.role==="professor"?"Professor":"Student"}: ${s.text}`).join(`
...
Professor:`}async function O(u){if(!u.trim()||A.value)return;D.value.push({id:L++,role:"student",text:u.trim()}),M.value="",await K(),P();const n={id:L++,role:"professor",text:"",streaming:!0,quiz:null};D.value.push(n),A.value=!0;let s="";const y=_.activeProject?.absolutePath??".";try{await Re({prompt:G(u.trim()),projectPath:y,onLine(S){try{const H=JSON.parse(S),Q=H?.type;if(Q==="result"){const q=H.result;typeof q=="string"&&q.trim()&&(s=q,n.text=q)}else if(Q==="assistant"){const q=H?.message?.content;if(Array.isArray(q))for(const N of q)N?.type==="text"&&typeof N.text=="string"&&(s+=N.text,n.text=s)}else Q==="text"&&typeof H.text=="string"&&(s+=H.text,n.text=s)}catch{S.trim()&&!S.startsWith("{")&&(s+=S,n.text=s)}K().then(P)},onClose(){const{cleanText:S,quiz:H}=$(s);n.text=S,n.quiz=H,n.streaming=!1,A.value=!1,K().then(P)},onError(S){n.text=`I'm having trouble connecting right now (${S}). Make sure Claude CLI is installed and logged in.`,n.streaming=!1,A.value=!1}})}catch(S){n.text=`Connection error: ${S?.message??"Unknown error"}`,n.streaming=!1,A.value=!1}}async function V(){await O(`Hello Professor! I'm ready to learn about Day ${p.lesson.day}: ${p.lesson.title}. Please introduce the topic and what I should focus on.`)}function o(){D.value=[],R.value=!1,E.value=v.aiModel??"claude"}function t(u,n){!u.quiz||u.quiz.answered||(u.quiz.answered=!0,u.quiz.selectedAnswer=n,O(`My answer is ${n}) ${u.quiz.options?.find(s=>s.letter===n)?.text??""}`))}function a(u){if(!u.quiz||u.quiz.answered||!u.quiz.studentInput?.trim())return;const n=u.quiz.studentInput.trim();u.quiz.answered=!0,O(n)}function g(u){u.key==="Enter"&&!u.shiftKey&&(u.preventDefault(),O(M.value))}function P(){x.value&&(x.value.scrollTop=x.value.scrollHeight)}function J(u){return u.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/`([^`]+)`/g,'<code class="inline-code">$1</code>').replace(/\n/g,"<br>")}return(u,n)=>(r(),l("div",Ne,[h(he,{"enter-active-class":"transition-all duration-200 ease-out","enter-from-class":"opacity-0 scale-95","enter-to-class":"opacity-100 scale-100","leave-active-class":"transition-all duration-150 ease-in","leave-from-class":"opacity-100 scale-100","leave-to-class":"opacity-0 scale-95",mode:"out-in"},{default:ge(()=>[i(R)?(r(),l("div",it,[e("div",st,[e("div",at,[h(i(Y),{class:"size-4 text-indigo-300"})]),e("div",nt,[n[7]||(n[7]=e("p",{class:"text-xs font-semibold text-[var(--text)]"},"Professor Vindicta",-1)),e("p",ot,d(i(v).aiModel==="codex"?"Codex":"Claude")+" · Day "+d(w.lesson.day),1)]),e("button",{class:"flex size-6 items-center justify-center rounded text-[var(--text-faint)] transition-colors hover:bg-white/[0.05] hover:text-[var(--text-muted)]",title:"Change model / reset session",onClick:o},[h(i(Me),{class:"size-3"})])]),e("div",{ref_key:"chatEl",ref:x,class:"flex-1 space-y-3 overflow-y-auto p-4 custom-scroll"},[i(D).length===0?(r(),l("div",rt,[h(i(oe),{class:"size-5 animate-spin text-indigo-400/50"})])):k("",!0),(r(!0),l(I,null,F(i(D),s=>(r(),l(I,{key:s.id},[s.role==="professor"?(r(),l("div",lt,[e("div",ct,[h(i(Y),{class:"size-3.5 text-indigo-300"})]),e("div",dt,[s.text?(r(),l("div",{key:0,class:"professor-bubble rounded-xl rounded-tl-none border border-indigo-500/15 bg-indigo-500/[0.08] px-3 py-2.5 text-xs leading-relaxed text-[var(--text-muted)]",innerHTML:J(s.text)},null,8,ut)):k("",!0),s.streaming&&!s.text?(r(),l("div",pt,[...n[8]||(n[8]=[e("span",{class:"size-1 rounded-full bg-indigo-400 animate-bounce",style:{"animation-delay":"0ms"}},null,-1),e("span",{class:"size-1 rounded-full bg-indigo-400 animate-bounce",style:{"animation-delay":"150ms"}},null,-1),e("span",{class:"size-1 rounded-full bg-indigo-400 animate-bounce",style:{"animation-delay":"300ms"}},null,-1)])])):k("",!0),s.quiz&&s.quiz.type==="mc"&&s.quiz.options?(r(),l("div",mt,[e("p",ht,d(s.quiz.question),1),e("div",gt,[(r(!0),l(I,null,F(s.quiz.options,y=>(r(),l("button",{key:y.letter,class:b(["flex w-full items-center gap-2 rounded-lg border px-3 py-2 text-left text-[11px] transition-colors",[s.quiz.answered?y.letter===s.quiz.selectedAnswer?"border-indigo-500/40 bg-indigo-500/15 text-indigo-200":"border-[var(--border)] text-[var(--text-faint)] opacity-50":"border-[var(--border)] hover:border-indigo-500/30 hover:bg-indigo-500/[0.06] text-[var(--text-muted)] cursor-pointer"]]),disabled:s.quiz.answered,onClick:S=>t(s,y.letter)},[e("span",ft,d(y.letter),1),T(" "+d(y.text),1)],10,yt))),128))])])):k("",!0),s.quiz&&(s.quiz.type==="text"||s.quiz.type==="number")&&!s.quiz.answered?(r(),l("div",bt,[e("p",vt,d(s.quiz.question),1),e("div",xt,[ne(e("input",{"onUpdate:modelValue":y=>s.quiz.studentInput=y,type:s.quiz.type==="number"?"number":"text",placeholder:"Your answer…",class:"flex-1 rounded-lg border border-[var(--border)] bg-black/20 px-3 py-1.5 text-xs text-[var(--text)] placeholder-[var(--text-faint)] outline-none focus:border-indigo-500/40",onKeydown:ke(y=>a(s),["enter"])},null,40,St),[[Ce,s.quiz.studentInput]]),e("button",{class:"flex items-center gap-1 rounded-lg bg-indigo-600/20 px-2.5 py-1.5 text-[11px] text-indigo-300 transition-colors hover:bg-indigo-600/30",onClick:y=>a(s)},[h(i(ae),{class:"size-3"}),n[9]||(n[9]=T(" Submit ",-1))],8,wt)])])):k("",!0)])])):(r(),l("div",kt,[e("div",Ct,[h(i(je),{class:"size-3.5 text-[var(--text-faint)]"})]),e("div",At,d(s.text),1)]))],64))),128)),!w.lessonCompleted&&i(D).length>4?(r(),l("div",Tt,[e("button",{class:"flex items-center gap-1.5 rounded-full border border-emerald-500/20 bg-emerald-500/[0.07] px-3 py-1.5 text-[11px] text-emerald-300 transition-colors hover:bg-emerald-500/10",onClick:n[0]||(n[0]=s=>m("markComplete"))},[...n[10]||(n[10]=[e("span",{class:"size-1.5 rounded-full bg-emerald-400 inline-block"},null,-1),T(" Mark lesson complete ",-1)])])])):k("",!0)],512),e("div",It,[e("div",Dt,[ne(e("textarea",{"onUpdate:modelValue":n[1]||(n[1]=s=>Ae(M)?M.value=s:null),rows:"1",placeholder:"Ask a question or respond…",class:"flex-1 resize-none bg-transparent text-[12px] text-[var(--text)] placeholder-[var(--text-faint)] outline-none",style:{"max-height":"80px","overflow-y":"auto"},disabled:i(A),onKeydown:g,onInput:n[2]||(n[2]=s=>{const y=s.target;y.style.height="auto",y.style.height=y.scrollHeight+"px"})},null,40,Pt),[[Te,i(M)]]),e("button",{disabled:!i(M).trim()||i(A),class:"flex size-6 shrink-0 items-center justify-center rounded-lg bg-indigo-600/20 text-indigo-300 transition-colors hover:bg-indigo-600/30 disabled:opacity-40",onClick:n[3]||(n[3]=s=>O(i(M)))},[i(A)?(r(),z(i(oe),{key:0,class:"size-3.5 animate-spin"})):(r(),z(i(Le),{key:1,class:"size-3.5"}))],8,Rt)]),n[11]||(n[11]=e("p",{class:"mt-1 px-1 text-[10px] text-[var(--text-faint)]"},"Enter to send · Shift+Enter for new line",-1))])])):(r(),l("div",Ue,[e("div",ze,[e("div",$e,[h(i(Y),{class:"size-6 text-indigo-300"})]),n[4]||(n[4]=e("p",{class:"text-sm font-semibold text-[var(--text)]"},"Professor Vindicta",-1)),e("p",Ve,[T(" AI tutor for Day "+d(w.lesson.day)+": ",1),e("span",Be,d(w.lesson.title),1)])]),e("div",Ge,[n[5]||(n[5]=e("p",{class:"text-center text-[10px] font-semibold uppercase tracking-widest text-[var(--text-faint)]"}," Choose AI model ",-1)),e("div",Qe,[(r(),l(I,null,F(W,s=>e("button",{key:s.id??"",class:b(["flex w-full items-start gap-3 rounded-xl border p-3 text-left transition-all",i(E)===s.id?[s.border,s.bg]:"border-[var(--border)] hover:border-white/10 hover:bg-white/[0.02]"]),onClick:y=>E.value=s.id},[e("div",{class:b(["mt-0.5 flex size-4 shrink-0 items-center justify-center rounded-full border transition-colors",i(E)===s.id?[s.border,s.bg]:"border-[var(--border)]"])},[i(E)===s.id?(r(),l("div",{key:0,class:b(["size-2 rounded-full",s.color.replace("text-","bg-")])},null,2)):k("",!0)],2),e("div",Ke,[e("div",Ye,[(r(),z(ye(s.icon),{class:b(["size-3.5 shrink-0",s.color])},null,8,["class"])),e("span",Ze,d(s.label),1),s.id==="claude"?(r(),l("span",Je," Recommended ")):k("",!0)]),e("p",et,d(s.sublabel),1),s.note?(r(),l("p",tt,d(s.note),1)):k("",!0)])],10,Xe)),64))])]),e("button",{class:"w-full rounded-xl bg-indigo-600/70 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-indigo-600",onClick:C}," Start Learning Session → "),n[6]||(n[6]=e("p",{class:"text-center text-[10px] text-[var(--text-faint)] leading-relaxed"}," The professor will introduce today's lesson, explain key concepts, and ask questions to check your understanding. ",-1))]))]),_:1})]))}}),Mt=Object.assign(fe(Et,[["__scopeId","data-v-c256b1f3"]]),{__name:"AIProfessorChat"}),Lt={class:"flex h-full flex-col overflow-hidden"},_t={key:0,class:"flex h-full items-center justify-center p-6"},Ht={class:"w-full max-w-xl space-y-8"},Ot={class:"text-center"},Ft={class:"mx-auto mb-4 grid size-16 place-items-center rounded-2xl border border-indigo-500/20 bg-indigo-500/10"},jt={class:"space-y-3"},qt={class:"grid gap-3 sm:grid-cols-2"},Wt=["onClick"],Nt={class:"flex items-center gap-2.5 mb-2"},Ut={class:"text-sm font-semibold text-[var(--text)]"},zt={class:"text-xs leading-relaxed text-[var(--text-muted)]"},$t={key:0,class:"space-y-2"},Vt={class:"grid gap-2 sm:grid-cols-2"},Bt=["onClick"],Gt={class:"text-xs font-semibold text-[var(--text)]"},Qt={class:"mt-0.5 text-[10px] text-[var(--text-faint)]"},Xt=["disabled"],Kt={class:"flex shrink-0 items-center gap-3 border-b border-[var(--border)] bg-[var(--bg-surface)] px-4 py-3"},Yt={class:"grid size-8 shrink-0 place-items-center rounded-lg border border-indigo-500/20 bg-indigo-500/10"},Zt={class:"flex-1 min-w-0"},Jt={class:"text-[11px] text-[var(--text-muted)]"},ei={class:"capitalize"},ti={class:"flex items-center gap-3 shrink-0"},ii={class:"w-28 rounded-full bg-white/[0.06] h-1.5"},si={class:"flex-1 overflow-y-auto p-4 space-y-6 custom-scroll"},ai={class:"flex items-center gap-1.5 overflow-x-auto"},ni=["onClick"],oi={class:"space-y-6"},ri={key:0,class:"space-y-3"},li={class:"flex items-center gap-2.5"},ci={class:"text-[10px] text-[var(--text-muted)]"},di={class:"grid gap-2.5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"},ui=["onClick"],pi={class:"flex items-center justify-between"},mi={key:1,class:"size-1.5 rounded-full bg-indigo-400"},hi={class:"text-xs font-semibold leading-snug text-[var(--text)] group-hover:text-white"},gi={class:"flex items-center gap-1 text-[10px] text-[var(--text-faint)]"},yi={class:"flex shrink-0 items-center gap-3 border-b border-[var(--border)] bg-[var(--bg-surface)] px-4 py-2.5"},fi={class:"flex-1 truncate text-sm font-semibold text-[var(--text)]"},bi={class:"flex shrink-0 items-center gap-2"},vi={class:"flex items-center gap-1 text-[10px] text-[var(--text-faint)]"},xi={class:"flex items-center gap-1 shrink-0"},Si=["disabled"],wi=["disabled"],ki={class:"mb-6 rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-4"},Ci={class:"space-y-1.5"},Ai=["innerHTML"],Ti={key:0,class:"mt-8 rounded-xl border border-amber-500/20 bg-amber-500/[0.06] p-4"},Ii={class:"text-xs leading-relaxed text-[var(--text-muted)]"},Di={class:"mt-8 flex items-center justify-between border-t border-[var(--border)] pt-5"},Pi={key:1},Ri={key:0,class:"flex w-[22rem] shrink-0 flex-col overflow-hidden"},Ei={key:3,class:"flex h-full items-center justify-center p-8"},Mi={class:"w-full max-w-lg space-y-8 text-center"},Li={class:"rounded-2xl border border-amber-500/25 bg-amber-500/[0.06] p-8 space-y-4"},_i={class:"mx-auto grid size-20 place-items-center rounded-full border border-amber-500/30 bg-amber-500/15"},Hi={class:"border-t border-amber-500/15 pt-4 space-y-1"},Oi={class:"text-sm font-semibold text-[var(--text)]"},Fi={class:"grid grid-cols-3 gap-3 pt-2"},ji={class:"rounded-lg border border-amber-500/15 p-2"},qi={class:"text-xl font-bold text-[var(--text)]"},Wi={class:"flex justify-center gap-3"},Ni=me({__name:"academy",setup(w){const c=be(),p=f("course"),m=f(null);Ie(async()=>{if(await c.loadFromDisk(),!c.setupComplete)p.value="setup";else if(c.allCompleted&&c.certificateIssuedAt)p.value="certificate";else if(p.value="course",c.lastVisitedLessonId){const o=We(c.lastVisitedLessonId);o&&(m.value=o)}});const v=f(null),_=f("claude"),R=[{id:"manual",label:"Self-Paced",description:"Study at your own pace with curated lesson content. No AI interactions.",icon:_e,color:"text-indigo-300",bg:"bg-indigo-500/10",border:"border-indigo-500/20"},{id:"ai-assisted",label:"AI-Assisted",description:"Learn with Professor Vindicta — an AI tutor who teaches, asks questions, and evaluates your understanding.",icon:Y,color:"text-violet-300",bg:"bg-violet-500/10",border:"border-violet-500/20"}],E=[{id:"claude",label:"Claude (Recommended)",description:"Anthropic Claude Code CLI"},{id:"codex",label:"Codex",description:"OpenAI Codex CLI"}];async function W(){v.value&&(await c.setSetup(v.value,_.value),p.value="course")}const C=f(null);function D(o){return X[o.week-1]??X[X.length-1]}function M(o){m.value=o,p.value="lesson",c.startLesson(o.id),c.setLastVisited("week-"+o.week,o.id)}const A=f(null),x=B(()=>{if(!m.value)return null;const o=U.findIndex(t=>t.id===m.value.id);return(o<U.length-1?U[o+1]:null)??null}),L=B(()=>{if(!m.value)return null;const o=U.findIndex(t=>t.id===m.value.id);return(o>0?U[o-1]:null)??null});async function $(){m.value&&(await c.completeLesson(m.value.id),c.allCompleted&&(p.value="certificate"))}function j(o){o&&(m.value=o,c.startLesson(o.id),c.setLastVisited("week-"+o.week,o.id),A.value?.scrollTo(0,0))}function G(o){let t=o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return t=t.replace(/```(\w*)\n([\s\S]*?)```/g,(a,g,P)=>`<pre class="code-block"><code class="lang-${g}">${P.trimEnd()}</code></pre>`),t=t.replace(/`([^`\n]+)`/g,'<code class="inline-code">$1</code>'),t=t.replace(/\|(.+)\|\n\|[-| :]+\|\n((?:\|.+\|\n?)*)/g,(a,g,P)=>{const J=g.split("|").filter(Boolean).map(n=>`<th>${n.trim()}</th>`).join(""),u=P.trim().split(`
`).map(n=>`<tr>${n.split("|").filter(Boolean).map(y=>`<td>${y.trim()}</td>`).join("")}</tr>`).join("");return`<table class="lesson-table"><thead><tr>${J}</tr></thead><tbody>${u}</tbody></table>`}),t=t.replace(/^### (.+)$/gm,"<h3>$1</h3>"),t=t.replace(/^## (.+)$/gm,"<h2>$1</h2>"),t=t.replace(/^# (.+)$/gm,"<h1>$1</h1>"),t=t.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),t=t.replace(/\*(.+?)\*/g,"<em>$1</em>"),t=t.replace(/((?:^- .+\n?)+)/gm,a=>`<ul>${a.trim().split(`
`).map(P=>`<li>${P.replace(/^- /,"")}</li>`).join("")}</ul>`),t=t.replace(/((?:^\d+\. .+\n?)+)/gm,a=>`<ol>${a.trim().split(`
`).map(P=>`<li>${P.replace(/^\d+\. /,"")}</li>`).join("")}</ol>`),t=t.replace(/\n{2,}/g,"</p><p>"),t=`<p>${t}</p>`,t=t.replace(/<p>\s*(<(?:h[1-6]|ul|ol|pre|table)[^>]*>)/g,"$1"),t=t.replace(/(<\/(?:h[1-6]|ul|ol|pre|table)>)\s*<\/p>/g,"$1"),t=t.replace(/<p><\/p>/g,""),t=t.replace(/\n/g,"<br>"),t=t.replace(/<br>\s*(<(?:li|tr|th|td|\/ul|\/ol))/g,"$1"),t}const O=B(()=>c.certificateIssuedAt?new Date(c.certificateIssuedAt).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}):"");async function V(){await c.resetSetup(),p.value="setup",m.value=null,C.value=null}return(o,t)=>(r(),l("div",Lt,[i(p)==="setup"?(r(),l("div",_t,[e("div",Ht,[e("div",Ot,[e("div",Ft,[h(i(ie),{class:"size-8 text-indigo-300"})]),t[7]||(t[7]=e("h1",{class:"text-2xl font-bold text-[var(--text)]"},"Security Bootcamp",-1)),t[8]||(t[8]=e("p",{class:"mt-1 text-sm text-[var(--text-muted)]"},"30-day hands-on curriculum from security fundamentals to professional pentesting",-1))]),e("div",jt,[t[9]||(t[9]=e("p",{class:"text-[10px] font-semibold uppercase tracking-widest text-[var(--text-faint)]"},"Choose your learning mode",-1)),e("div",qt,[(r(),l(I,null,F(R,a=>e("button",{key:a.id??"unknown",class:b(["rounded-xl border p-4 text-left transition-all",i(v)===a.id?[a.border,a.bg]:"border-[var(--border)] hover:border-indigo-500/20 hover:bg-white/[0.02]"]),onClick:g=>v.value=a.id},[e("div",Nt,[e("div",{class:b(["grid size-8 shrink-0 place-items-center rounded-lg",[a.bg,a.border,"border"]])},[(r(),z(ye(a.icon),{class:b(["size-4",a.color])},null,8,["class"]))],2),e("span",Ut,d(a.label),1)]),e("p",zt,d(a.description),1)],10,Wt)),64))])]),h(he,{"enter-active-class":"transition-all duration-200 ease-out","enter-from-class":"opacity-0 -translate-y-2","enter-to-class":"opacity-100 translate-y-0","leave-active-class":"transition-all duration-150 ease-in","leave-from-class":"opacity-100","leave-to-class":"opacity-0"},{default:ge(()=>[i(v)==="ai-assisted"?(r(),l("div",$t,[t[10]||(t[10]=e("p",{class:"text-[10px] font-semibold uppercase tracking-widest text-[var(--text-faint)]"},"AI model for professor",-1)),e("div",Vt,[(r(),l(I,null,F(E,a=>e("button",{key:a.id??"unknown",class:b(["rounded-xl border p-3 text-left transition-all",i(_)===a.id?"border-violet-500/30 bg-violet-500/10":"border-[var(--border)] hover:border-violet-500/20"]),onClick:g=>_.value=a.id},[e("p",Gt,d(a.label),1),e("p",Qt,d(a.description),1)],10,Bt)),64))])])):k("",!0)]),_:1}),e("button",{disabled:!i(v),class:"w-full rounded-xl bg-indigo-600/80 py-3 text-sm font-semibold text-white transition-all hover:bg-indigo-600 disabled:opacity-40",onClick:W}," Start Bootcamp → ",8,Xt),t[11]||(t[11]=De('<div class="flex justify-center gap-6 text-center" data-v-68d46885><div data-v-68d46885><p class="text-lg font-bold text-[var(--text)]" data-v-68d46885>30</p><p class="text-[10px] text-[var(--text-faint)]" data-v-68d46885>Days</p></div><div data-v-68d46885><p class="text-lg font-bold text-[var(--text)]" data-v-68d46885>~45h</p><p class="text-[10px] text-[var(--text-faint)]" data-v-68d46885>Content</p></div><div data-v-68d46885><p class="text-lg font-bold text-[var(--text)]" data-v-68d46885>1</p><p class="text-[10px] text-[var(--text-faint)]" data-v-68d46885>Certificate</p></div></div>',1))])])):i(p)==="course"?(r(),l(I,{key:1},[e("div",Kt,[e("div",Yt,[h(i(ie),{class:"size-4 text-indigo-300"})]),e("div",Zt,[t[13]||(t[13]=e("h1",{class:"text-sm font-semibold text-[var(--text)]"},"30-Day Security Bootcamp",-1)),e("p",Jt,[T(d(i(c).completedCount)+"/"+d(i(pe))+" days completed · "+d(i(c).progressPercent)+"% · ",1),e("span",ei,d(i(c).mode??"manual"),1),t[12]||(t[12]=T(" mode ",-1))])]),e("div",ti,[e("div",ii,[e("div",{class:"h-1.5 rounded-full bg-indigo-500 transition-all",style:Pe({width:i(c).progressPercent+"%"})},null,4)]),e("button",{class:"text-[10px] text-[var(--text-faint)] hover:text-[var(--text-muted)] transition-colors",title:"Reset progress",onClick:V},[h(i(re),{class:"size-3"})])])]),e("div",si,[e("div",ai,[e("button",{class:b(["shrink-0 rounded-lg border px-3 py-1 text-[11px] font-medium transition-colors",i(C)===null?"border-indigo-500/30 bg-indigo-500/10 text-indigo-300":"border-[var(--border)] text-[var(--text-faint)] hover:text-[var(--text-muted)]"]),onClick:t[0]||(t[0]=a=>C.value=null)}," All Days ",2),(r(!0),l(I,null,F(i(X),a=>(r(),l("button",{key:a.number,class:b(["shrink-0 rounded-lg border px-3 py-1 text-[11px] font-medium transition-colors",i(C)===a.number?[a.border,a.bg,a.color]:"border-[var(--border)] text-[var(--text-faint)] hover:text-[var(--text-muted)]"]),onClick:g=>C.value=a.number===i(C)?null:a.number},d(a.title)+" — "+d(a.theme),11,ni))),128))]),e("div",oi,[(r(!0),l(I,null,F(i(X),a=>(r(),l(I,{key:a.number},[!i(C)||i(C)===a.number?(r(),l("div",ri,[e("div",li,[t[15]||(t[15]=e("div",{class:"h-px flex-1 bg-[var(--border)]"},null,-1)),e("div",{class:b(["flex items-center gap-2 rounded-full border px-3 py-1",[a.border,a.bg]])},[e("span",{class:b(["text-[10px] font-bold uppercase tracking-widest",a.color])},d(a.title),3),t[14]||(t[14]=e("span",{class:"text-[10px] text-[var(--text-faint)]"},"·",-1)),e("span",ci,d(a.theme),1)],2),t[16]||(t[16]=e("div",{class:"h-px flex-1 bg-[var(--border)]"},null,-1))]),e("div",di,[(r(!0),l(I,null,F(i(U).filter(g=>g.week===a.number),g=>(r(),l("button",{key:g.id,class:b(["group relative flex flex-col gap-1.5 rounded-xl border p-3 text-left transition-all",[i(c).isCompleted(g.id)?"border-emerald-500/25 bg-emerald-500/[0.06] hover:bg-emerald-500/10":g.id===i(c).lastVisitedLessonId&&!i(c).isCompleted(g.id)?"border-indigo-500/30 bg-indigo-500/[0.06] hover:bg-indigo-500/10":"border-[var(--border)] hover:border-indigo-500/20 hover:bg-white/[0.03]"]]),onClick:P=>M(g)},[e("div",pi,[e("span",{class:b(["text-[10px] font-bold uppercase tracking-widest",D(g).color])}," Day "+d(g.day),3),i(c).isCompleted(g.id)?(r(),z(i(te),{key:0,class:"size-3.5 text-emerald-400"})):g.id===i(c).lastVisitedLessonId?(r(),l("div",mi)):(r(),z(i(He),{key:2,class:"size-3 text-[var(--border)]"}))]),e("p",hi,d(g.title),1),e("div",gi,[h(i(le),{class:"size-2.5 shrink-0"}),T(" "+d(g.duration),1)])],10,ui))),128))])])):k("",!0)],64))),128))])])],64)):i(p)==="lesson"&&i(m)?(r(),l(I,{key:2},[e("div",yi,[e("button",{class:"flex items-center gap-1 text-[11px] text-[var(--text-faint)] transition-colors hover:text-[var(--text-muted)]",onClick:t[1]||(t[1]=a=>p.value="course")},[h(i(se),{class:"size-3.5"}),t[17]||(t[17]=T(" Course ",-1))]),t[19]||(t[19]=e("div",{class:"h-3 w-px bg-[var(--border)]"},null,-1)),e("span",{class:b(["text-[10px] font-bold uppercase tracking-widest",D(i(m)).color])}," Day "+d(i(m).day),3),e("h2",fi,d(i(m).title),1),e("div",bi,[e("span",vi,[h(i(le),{class:"size-3"}),T(" "+d(i(m).duration),1)]),i(c).isCompleted(i(m).id)?(r(),z(i(te),{key:0,class:"size-4 text-emerald-400"})):(r(),l("button",{key:1,class:"flex items-center gap-1.5 rounded-lg border border-emerald-500/25 bg-emerald-500/10 px-2.5 py-1 text-[11px] font-medium text-emerald-300 transition-colors hover:bg-emerald-500/15",onClick:$},[h(i(te),{class:"size-3"}),t[18]||(t[18]=T(" Mark Complete ",-1))]))]),e("div",xi,[e("button",{disabled:!i(L),class:"flex size-7 items-center justify-center rounded border border-[var(--border)] text-[var(--text-faint)] transition-colors hover:bg-white/[0.05] hover:text-[var(--text)] disabled:opacity-30",title:"Previous lesson",onClick:t[2]||(t[2]=a=>j(i(L)))},[h(i(se),{class:"size-3.5"})],8,Si),e("button",{disabled:!i(x),class:"flex size-7 items-center justify-center rounded border border-[var(--border)] text-[var(--text-faint)] transition-colors hover:bg-white/[0.05] hover:text-[var(--text)] disabled:opacity-30",title:"Next lesson",onClick:t[3]||(t[3]=a=>j(i(x)))},[h(i(ae),{class:"size-3.5"})],8,wi)])]),e("div",{class:b(["flex flex-1 overflow-hidden",i(c).mode==="ai-assisted"?"gap-0":""])},[e("div",{ref_key:"lessonContentEl",ref:A,class:b(["flex-1 overflow-y-auto p-6 custom-scroll",i(c).mode==="ai-assisted"?"border-r border-[var(--border)]":"mx-auto max-w-3xl"])},[e("div",ki,[t[20]||(t[20]=e("p",{class:"mb-2 text-[10px] font-semibold uppercase tracking-widest text-[var(--text-faint)]"}," Today's Objectives ",-1)),e("ul",Ci,[(r(!0),l(I,null,F(i(m).objectives,a=>(r(),l("li",{key:a,class:"flex items-start gap-2 text-xs text-[var(--text-muted)]"},[h(i(Fe),{class:"mt-0.5 size-3 shrink-0 text-indigo-400"}),T(" "+d(a),1)]))),128))])]),e("div",{class:"prose-lesson",innerHTML:G(i(m).content)},null,8,Ai),i(m).labHint?(r(),l("div",Ti,[t[21]||(t[21]=e("p",{class:"mb-1.5 text-[10px] font-semibold uppercase tracking-widest text-amber-400"},"Lab Exercise",-1)),e("p",Ii,d(i(m).labHint),1)])):k("",!0),e("div",Di,[i(L)?(r(),l("button",{key:0,class:"flex items-center gap-2 text-xs text-[var(--text-muted)] transition-colors hover:text-[var(--text)]",onClick:t[4]||(t[4]=a=>j(i(L)))},[h(i(se),{class:"size-3.5"}),e("span",null,"Day "+d(i(L).day)+": "+d(i(L).title),1)])):(r(),l("div",Pi)),i(x)?(r(),l("button",{key:2,class:"flex items-center gap-2 text-xs text-[var(--text-muted)] transition-colors hover:text-[var(--text)]",onClick:t[5]||(t[5]=a=>j(i(x)))},[e("span",null,"Day "+d(i(x).day)+": "+d(i(x).title),1),h(i(ae),{class:"size-3.5"})])):k("",!0)])],2),i(c).mode==="ai-assisted"?(r(),l("div",Ri,[h(Mt,{lesson:i(m),"lesson-completed":i(c).isCompleted(i(m).id),onMarkComplete:$},null,8,["lesson","lesson-completed"])])):k("",!0)],2)],64)):i(p)==="certificate"?(r(),l("div",Ei,[e("div",Mi,[e("div",Li,[e("div",_i,[h(i(Oe),{class:"size-10 text-amber-300"})]),t[26]||(t[26]=e("div",null,[e("p",{class:"text-[10px] font-semibold uppercase tracking-[0.2em] text-amber-400"},"Certificate of Completion"),e("h1",{class:"mt-2 text-2xl font-bold text-[var(--text)]"},"Security Engineering Bootcamp"),e("p",{class:"mt-1 text-sm text-[var(--text-muted)]"},"30-Day Cybersecurity Programme")],-1)),e("div",Hi,[t[22]||(t[22]=e("p",{class:"text-xs text-[var(--text-faint)]"},"Issued on",-1)),e("p",Oi,d(i(O)),1)]),e("div",Fi,[t[24]||(t[24]=e("div",{class:"rounded-lg border border-amber-500/15 p-2"},[e("p",{class:"text-xl font-bold text-[var(--text)]"},"30"),e("p",{class:"text-[10px] text-[var(--text-faint)]"},"Days")],-1)),e("div",ji,[e("p",qi,d(i(pe)),1),t[23]||(t[23]=e("p",{class:"text-[10px] text-[var(--text-faint)]"},"Lessons",-1))]),t[25]||(t[25]=e("div",{class:"rounded-lg border border-amber-500/15 p-2"},[e("p",{class:"text-xl font-bold text-[var(--text)]"},"100%"),e("p",{class:"text-[10px] text-[var(--text-faint)]"},"Complete")],-1))])]),e("div",Wi,[e("button",{class:"flex items-center gap-2 rounded-xl border border-[var(--border)] px-4 py-2.5 text-sm text-[var(--text-muted)] transition-colors hover:bg-white/[0.04] hover:text-[var(--text)]",onClick:t[6]||(t[6]=a=>p.value="course")},[h(i(ie),{class:"size-4"}),t[27]||(t[27]=T(" Review Course ",-1))]),e("button",{class:"flex items-center gap-2 rounded-xl border border-red-500/20 px-4 py-2.5 text-sm text-[var(--text-muted)] transition-colors hover:bg-red-500/[0.05] hover:text-red-300",onClick:V},[h(i(re),{class:"size-4"}),t[28]||(t[28]=T(" Start Over ",-1))])])])])):k("",!0)]))}}),ss=fe(Ni,[["__scopeId","data-v-68d46885"]]);export{ss as default};
