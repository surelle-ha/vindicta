...
import{e as S,f as N,h as z,o as a,c,a as e,b as u,j as s,n as _,d as m,t as l,p as O,v as V,z as I,k as j,m as h,F as R,r as q,C as D,q as b,s as C,x as J}from"./yjyGEl7p.js";import{u as H}from"./DyP4eKk_.js";import{u as L}from"./DFb_gMt9.js";import{P as $}from"./Dv1_PGwv.js";import{T as F}from"./RUkByUhO.js";import{L as E}from"./DbGmkHx5.js";import{P as B}from"./B40TjfLj.js";import{W as G}from"./D39gTU0a.js";import{I as W}from"./Am_B6th4.js";import{T as U}from"./C3yglN6r.js";import"./CqN_TyiF.js";import"./CxHgyGSH.js";import"./Bl8c77H5.js";const K=S("copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]);const Q=S("square",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}]]),X={class:"mx-auto max-w-5xl space-y-5 pb-8"},Y={class:"flex items-center gap-3"},Z={class:"grid size-10 place-items-center rounded-xl border border-violet-500/25 bg-violet-500/10"},ee={class:"grid gap-5 xl:grid-cols-[1fr_20rem]"},te={class:"space-y-5"},se={class:"rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-4"},re={class:"flex items-center justify-between gap-3"},oe={class:"flex items-center gap-2"},ne={class:"flex items-center gap-2"},ie={class:"mt-4 flex flex-wrap items-end gap-3"},ae={class:"block"},de=["disabled"],ce=["disabled"],le={key:0,class:"mt-3 rounded-lg border border-emerald-500/20 bg-emerald-500/[0.06] px-3 py-2"},pe={class:"text-xs text-emerald-300"},ue={class:"font-mono"},me={key:1,class:"mt-3"},fe={class:"max-h-40 overflow-auto whitespace-pre-wrap rounded-lg border border-[var(--border)] bg-black/20 p-3 text-[11px] leading-relaxed text-[var(--text-muted)] custom-scroll"},ge={class:"rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-4"},ve={class:"flex items-center gap-2"},xe={class:"mt-3 space-y-2"},be={class:"flex flex-wrap items-baseline gap-2"},he={class:"font-mono text-xs font-semibold text-violet-300"},ye={key:0,class:"font-mono text-[10px] text-[var(--text-faint)]"},_e={class:"mt-0.5 text-xs text-[var(--text-muted)]"},je={class:"space-y-5"},Ce={class:"rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-4"},Se={class:"flex items-center gap-2"},ke={class:"rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-4"},Pe={class:"flex items-center gap-2"},we={key:0,class:"mt-2 rounded-lg border border-[var(--border)] bg-black/10 p-3"},Te={class:"text-xs font-medium text-[var(--text)]"},Me={class:"mt-0.5 break-words text-[10px] text-[var(--text-muted)]"},Ae={key:1,class:"mt-2 text-xs text-[var(--text-muted)]"},Ne={class:"rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-4"},ze={class:"flex items-center justify-between gap-2"},Oe={class:"flex items-center gap-2"},Ve={class:"mt-3 overflow-auto rounded-lg border border-[var(--border)] bg-black/20 p-3 text-[10px] leading-relaxed text-[var(--text-muted)] custom-scroll"},Ke=N({__name:"mcp",setup(Ie){const k=z();H();const{notify:f}=L(),n=b(!1),g=b(!1),p=b(7474),o=b([]);let v=null;const x=C(()=>k.activeProject),P=[{name:"list_projects",description:"Returns all projects registered in Vindicta.",params:"none"},{name:"get_project",description:"Returns metadata for a specific project by ID.",params:"{ project_id: string }"},{name:"get_findings",description:"Returns all security remediation findings for the active or specified project.",params:"{ project_id?: string, status?: string, severity?: string }"},{name:"get_scans",description:"Returns the scan history and raw AI reports for the active or specified project.",params:"{ project_id?: string, limit?: number }"},{name:"get_security_summary",description:"Returns a concise security posture summary: open findings count, high-risk count, last scan time.",params:"{ project_id?: string }"},{name:"run_diagnostics",description:"Runs dependency and secret pattern scans on the specified project and returns the findings.",params:"{ project_id: string }"}],y=C(()=>{const i={mcpServers:{vindicta:{command:"node",args:["<path-to-vindicta-mcp-server.js>"],env:{VINDICTA_PORT:String(p.value)}}}};return JSON.stringify(i,null,2)});async function w(){if(!(n.value||g.value)){g.value=!0,o.value=[];try{const{Command:i}=await J(async()=>{const{Command:d}=await import("./i8hHMFjf.js");return{Command:d}},__vite__mapDeps([0,1]),import.meta.url),t=x.value?.absolutePath??"",r=i.create("node-mcp-server",["-e",A(t)]);r.stdout.on("data",d=>{o.value.push(`[out] ${d.trim()}`),o.value.length>100&&o.value.shift()}),r.stderr.on("data",d=>{o.value.push(`[err] ${d.trim()}`),o.value.length>100&&o.value.shift()}),r.on("close",()=>{n.value=!1,o.value.push("[server stopped]")}),r.on("error",d=>{n.value=!1,o.value.push(`[error] ${d}`)}),v=await r.spawn(),n.value=!0,o.value.push(`[server started on port ${p.value}]`),f(`MCP server started on port ${p.value}.`,"success")}catch(i){const t=i?.message??String(i);o.value.push(`[failed to start] ${t}`);const r=t.toLowerCase(),d=r.includes("not allowed")||r.includes("forbidden")||r.includes("permission")?"Shell permission denied. Check Tauri capabilities config.":r.includes("enoent")||r.includes("not found")?'Node.js not found. Make sure "node" is installed and in your PATH.':"Failed to start MCP server. Make sure Node.js is installed.";f(d,"error")}finally{g.value=!1}}}async function T(){try{v&&(await v.kill(),v=null),n.value=!1,o.value.push("[server stopped by user]"),f("MCP server stopped.","success")}catch(i){f(i?.message??"Could not stop the MCP server.","error")}}function M(){navigator.clipboard.writeText(y.value).then(()=>{f("Claude Desktop config copied to clipboard.","success")})}function A(i){return`
